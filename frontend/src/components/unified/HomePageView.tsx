      ...
      <div style={{ maxWidth: 900, width: '100%', textAlign: 'center' }}>
        <Flex vertical gap="large" style={{ width: '100%' }}>
          ...
          <div style={{ marginBottom: 32 }}>
            <Title level={1} style={{ fontSize: '3rem', marginBottom: 16, fontWeight: 700 }}>
              {titleParts.length > 0 && (
                <TypewriterEffect
                  parts={titleParts}
                  speed={150}
            ...
            <Paragraph style={{ fontSize: '1.1rem', color: token.colorTextSecondary, maxWidth: 700, margin: '0 auto' }}>
          ...
          <div style={{ marginTop: 32 }}>
            <Text type="secondary" style={{ display: 'block', marginBottom: 16, fontSize: 15 }}>试试这些搜索</Text>
            <Flex
              wrap
              gap="small"
              style={{
